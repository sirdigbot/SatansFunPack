...
#define UPDATE_URL  "https://sirdigbot.github.io/SatansFunPack/sourcemod/groupmanager_update.txt"
...
public void OnPluginStart()
{
  ...
  LoadTranslations("sfp.groupmanager.phrases");

  h_bUpdate = CreateConVar("sm_sfp_groupmanager_update", "1", "Update Satan's Fun Pack - Group Manager Automatically (Requires Updater)\n(Default: 1)", FCVAR_NONE, true, 0.0, true, 1.0);
